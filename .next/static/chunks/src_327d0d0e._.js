...
const AuthProvider = ({ children })=>{
    ...
    const [user, setUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "AuthProvider.useState": ()=>getUserFromStorage()
        ...
        "AuthProvider.useCallback[login]": (email, password)=>{
            ...
            if (user) {
                ...
                const updatedUsers = users.map({
                    "AuthProvider.useCallback[login].updatedUsers": (u)=>u.id === user.id ? updatedUser : u
                }["AuthProvider.useCallback[login].updatedUsers"]);
                ...
                if (email === 'admin@careercompass.com' && password === 'admin123') {
                    ...
                    const newUser = {
                        id: `user-${Date.now()}`,
                        email,
                        name: email.split('@')[0].replace(/(?:^|\s)\S/g, {
                            "AuthProvider.useCallback[login]": (a)=>a.toUpperCase()
    ...
    const updateUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[updateUser]": (updatedUser)=>{
            const users = getUsersFromStorage();
            const updatedUsers = users.map({
                "AuthProvider.useCallback[updateUser].updatedUsers": (u)=>u.id === updatedUser.id ? updatedUser : u
    ...
    const changePassword = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[changePassword]": (userId, newPassword)=>{
            const users = getUsersFromStorage();
            const updatedUsers = users.map({
                "AuthProvider.useCallback[changePassword].updatedUsers": (u)=>u.id === userId ? {
                        ...u,
                        password: newPassword
                    } : u
            }["AuthProvider.useCallback[changePassword].updatedUsers"]);
            saveUsersToStorage(updatedUsers);
            if (user?.id === userId) {
                const updatedUser = {
                    ...user,
    ...
    const addTodo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[addTodo]": (todo)=>{
            if (!user) return;
            const newTodo = {
                ...todo,
                id: `todo-${Date.now()}`,
    ...
    }["AuthProvider.useCallback[addTodo]"], [
        user,
        updateUser
    ]);
    const updateTodo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[updateTodo]": (todoId, updates)=>{
            if (!user) return;
            const updatedUser = {
                ...user,
                todoList: (user.todoList || []).map({
                    "AuthProvider.useCallback[updateTodo]": (todo)=>todo.id === todoId ? {
                            ...todo,
                            ...updates
                        } : todo
                }["AuthProvider.useCallback[updateTodo]"])
            };
            updateUser(updatedUser);
        }
    }["AuthProvider.useCallback[updateTodo]"], [
    ...
    const deleteTodo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[deleteTodo]": (todoId)=>{
            if (!user) return;
            const updatedUser = {
                ...user,
                todoList: (user.todoList || []).filter({
                    "AuthProvider.useCallback[deleteTodo]": (todo)=>todo.id !== todoId
                }["AuthProvider.useCallback[deleteTodo]"])
            };
            updateUser(updatedUser);
        }
    }["AuthProvider.useCallback[deleteTodo]"], [
    ...
    const addHistory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[addHistory]": (history)=>{
            if (!user) return;
            const newHistory = {
                ...history,
                id: `history-${Date.now()}`,
    ...
    }["AuthProvider.useCallback[addHistory]"], [
        user,
        updateUser
    ]);
    const saveItem = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[saveItem]": (item)=>{
            if (!user) return;
            const newSavedItem = {
                ...item,
                id: `saved-${Date.now()}`,
    ...
    }["AuthProvider.useCallback[saveItem]"], [
        user,
        updateUser
    ]);
    const deleteSavedItem = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[deleteSavedItem]": (itemId)=>{
            if (!user) return;
            const updatedUser = {
                ...user,
                savedItems: (user.savedItems || []).filter({
                    "AuthProvider.useCallback[deleteSavedItem]": (item)=>item.id !== itemId
                }["AuthProvider.useCallback[deleteSavedItem]"])
            };
            updateUser(updatedUser);
        }
    }["AuthProvider.useCallback[deleteSavedItem]"], [
...
_s(AuthProvider, "N2h22P1MP4ijixa6bvx3azOlvBg=", false, function() {
    return [
...
function Navigation() {
    _s();
    const { user, logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$auth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
...
_s(Navigation, "73zrTs0hl6a/j1Tjsca6S4ZmeoQ=", false, function() {
    return [
...
"[project]/src/components/ui/page-transition.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
_s(PageTransition, "qIOWh+H4KANmZw/Ng5wnr7tzXF0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"]
    ];
});
...
//# sourceMappingURL=src_327d0d0e._.js.map